...
// Schema for meal plan generation (backward compatible)
export const MealPlanRequestSchema = z.object({
  ...
  userProfile: z.union([
    UserProfileSchema, // Full profile for new requests
    z.object({
      preferences: z.object({
...
// Schema for user profile creation during registration
